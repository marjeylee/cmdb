...
function query_login_info(data) {
	var login_cookie = ''
	$.ajax({
		type: "POST",
		contentType: "application/json;charset=UTF-8",
		url: "http://" + SERVER_IP + '/valid_login_info',
		data: JSON.stringify(data),
		async: false,
		success: function(result) {
			login_cookie = result
...
function check_cookies_valid(data) {
	var is_cookie_valid = false
	$.ajax({
		type: "POST",
		contentType: "application/json;charset=UTF-8",
		url: "http://" + SERVER_IP + '/check_cookies_valid',
		data: JSON.stringify(data),
		async: false,
		success: function(result) {
			if (result==='True'){
